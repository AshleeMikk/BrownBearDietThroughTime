...
TLModels[[9]] <-  
  AgexSexBilbMod.Lag <- 
  lmer(ZN15~ Zage+sex+Zage*sex+Zbilb_lag+
         (1|BearID)+(1|Repro),
       data = SI_Diet_Tlag)
...
TLModels[[11]] <-  
  AgexSexBilbMod.LagData <- 
  lmer(ZN15~ Zage+sex+Zage*sex+Zbilb+
         (1|BearID)+(1|Repro),
       data = SI_Diet_Tlag)

summary(AgexSexBilbMod.LagData)
AIcc_AgexSexBilbLagData <- wiqid::AICc(AgexSexBilbMod.LagData)



TLModels[[12]] <-  
  AgexSexBilMharvbMod.LagData <- 
  lmer(ZN15~ Zage+
         sex+
         Zage*sex+
         Zbilb+
