...
BearDietEst.SfemsSubset.Posterior<-read.csv("SfemSubsetPosteriors_Priors.csv")
...
```{r}
BearDietEst.Sfems.PosteriorDietEst.Sfems.2019.Subset <- read.csv("SfemSubsetPosteriors.csv")

SFsub_Post_Full <- ggplot(data = BearDietEst.Sfems.Posterior)+
  geom_area(aes(Ants), stat = "bin",
            bins=100,
            alpha=0.3,
            fill=P[1],
